  ...
  return (
    <div className="home">
      ...
      <section className="skills-section">
        ...
        <h2 className="section-heading">11 Comprehensive SEO Skills</h2>
        <p className="section-sub">Every audit runs all 11 skills in parallel — no cherry-picking, no guesswork.</p>
